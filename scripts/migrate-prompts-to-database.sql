...
-- First, let's see what system defaults currently exist
SELECT document_type, name, is_system_default, is_active 
FROM prompt_templates 
WHERE prompt_scope = 'system' AND is_system_default = true
ORDER BY document_type;

-- Business Analysis: Update existing or insert new
DO $$
BEGIN
    -- Try to update existing business analysis system default
    UPDATE prompt_templates SET
        name = 'Enterprise Business Analysis - System Default',
...
Focus on the SPECIFIC project requirements provided. Avoid generic enterprise examples.',
    ...
    IF NOT FOUND THEN
        INSERT INTO prompt_templates (
            id, name, description, document_type, prompt_content, variables, ai_model,
            is_active, is_system_default, version, prompt_scope, created_by, created_at, updated_at
        ) VALUES (
            gen_random_uuid(),
...
-- Functional Specification: Update existing or insert new
DO $$
BEGIN
    UPDATE prompt_templates SET
        name = 'Enterprise Functional Specification - System Default',
...
-- Technical Specification: Update existing or insert new
DO $$
BEGIN
    UPDATE prompt_templates SET
        name = 'Enterprise Technical Specification - System Default',
...
-- UX Specification: Update existing or insert new
DO $$
BEGIN
    UPDATE prompt_templates SET
        name = 'Enterprise UX Specification - System Default',
...
-- Mermaid Diagrams: Update existing or insert new
DO $$
BEGIN
    UPDATE prompt_templates SET
        name = 'Enterprise Mermaid Diagrams - System Default',
...
-- Final verification: Check what we now have
SELECT 
    document_type,
    name,
    is_active,
