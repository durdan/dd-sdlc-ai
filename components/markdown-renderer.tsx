    ...
    <Card className={`${typeStyles[type]} shadow-sm`}>
      ...
      <CardContent className="prose prose-gray max-w-none">
        <ReactMarkdown
          ...
          components={{
            h1: ({node, ...props}) => <h1 className="text-3xl font-bold text-gray-900 mb-4 mt-6 border-b border-gray-200 pb-2" {...props} />,
            ...
            h4: ({node, ...props}) => <h4 className="text-lg font-medium text-gray-700 mb-2 mt-3" {...props} />,
            h5: ({node, ...props}) => <h5 className="text-base font-medium text-gray-700 mb-1 mt-2" {...props} />,
            h6: ({node, ...props}) => <h6 className="text-sm font-medium text-gray-600 mb-1 mt-2" {...props} />,
            ...
            blockquote: ({node, ...props}) => <blockquote className="border-l-4 border-blue-500 pl-4 py-2 bg-blue-50 rounded-r-lg mb-4 italic text-gray-700" {...props} />,
            ...
            table: ({node, ...props}) => <table className="min-w-full divide-y divide-gray-200 mb-4 border border-gray-200 rounded-lg overflow-hidden" {...props} />,
