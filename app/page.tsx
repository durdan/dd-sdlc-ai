  ...
  return (
    <div className="flex flex-col min-h-screen bg-black text-white">
      ...
      <main className="flex-1">
          ...
          <div className="mx-auto max-w-7xl">
            <div className="text-center space-y-8">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <Button
                  size="lg"
                  className="h-14 px-8 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white border-0 text-lg font-medium"
                ...
                <Button
                  variant="outline"
                  size="lg"
                  className="h-14 px-8 bg-transparent border-gray-700 text-gray-300 hover:bg-gray-900 hover:text-white text-lg font-medium"
                  onClick={() => document.getElementById('try-ai')?.scrollIntoView({ behavior: 'smooth' })}
                >
        ...
        <section id="try-ai" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="mx-auto max-w-5xl px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-400">Ask anything about your development workflow</p>
            </div>

            {/* Chat Interface */}
            <div className="relative max-w-4xl mx-auto">
              <div className="absolute inset-0 bg-gradient-to-r from-blue-500/10 via-purple-500/10 to-pink-500/10 blur-2xl" />
              <Card className="relative bg-gray-900/80 border-gray-700 backdrop-blur">
                <CardContent className="p-6 md:p-8">
                  ...
                  <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-white">SDLC AI Assistant</h3>
                  ...
                  <div className="relative mb-6">
                    <div className="space-y-4">
                      ...
                      <Textarea
                        ...
                        className="min-h-[120px] bg-gray-800 border-gray-700 text-white placeholder-gray-500 focus:border-blue-500 focus:ring-blue-500"
                      />
                      <Button
