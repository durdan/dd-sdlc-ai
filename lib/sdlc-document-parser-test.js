// Simple test script for the SDLC document parser
const { parseDocumentSections, parseSDLCDocument, ensureDefaultSubsections } = require('./dist/sdlc-document-parser');
